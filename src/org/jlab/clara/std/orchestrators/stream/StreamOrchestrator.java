 ...
 * input files.
 */
public final class StreamOrchestrator extends AbstractStreamOrchestrator {

    private final StreamOrchestrator.DpeReportCB dpeCallback;
    ...
    public static void main(String[] args) {
        StreamOrchestrator.CommandLineBuilder cl = new StreamOrchestrator.CommandLineBuilder();
        try {
            cl.parse(args);
            if (cl.hasVersion()) {
            ...
            StreamOrchestrator fo = cl.build();
        ...
        } catch (StreamOrchestrator.CommandLineException e) {
    ...
    /**
     * Helps constructing a {@link StreamOrchestrator} with all default and
     * required parameters.
     */
    public static class Builder {
         ...
         */
        public StreamOrchestrator.Builder withFrontEnd(DpeName frontEnd) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder cloudMode() {
            options.cloudMode();
            return this;
        }
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withSession(String session) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder useFrontEnd() {
            options.useFrontEnd();
            return this;
        }
         ...
         */
        public StreamOrchestrator.Builder useStageDirectory() {
            options.stageFiles();
            return this;
        }
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withPoolSize(int poolSize) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withMaxThreads(int maxThreads) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withMaxNodes(int maxNodes) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withReportFrequency(int frequency) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withSkipEvents(int skip) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withMaxEvents(int max) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withInputDirectory(String inputDir) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withOutputDirectory(String outputDir) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withOutputFilePrefix(String outputFilePrefix) {
         ...
         * @return this object, so methods can be chained
         */
        public StreamOrchestrator.Builder withStageDirectory(String stageDir) {
         ...
         */
        public StreamOrchestrator build() {
            return new StreamOrchestrator(setup.build(), paths.build(), options.build());
        }
    }


    private StreamOrchestrator(OrchestratorSetup setup,
                                OrchestratorPaths paths,
                                OrchestratorOptions options) {
        super(setup, paths, options);
        Logging.verbose(true);
        dpeCallback = new StreamOrchestrator.DpeReportCB(orchestrator, options, setup.application,
            this::executeSetup);
    ...
    protected void start() {
        ...
        if (options.orchMode != OrchestratorMode.CLOUD) {
            StreamProcessingNode localNode = dpeCallback.getLocalNode();
    ...
    void subscribe(StreamProcessingNode node) {
        ...
        if (options.orchMode != OrchestratorMode.CLOUD) {
            node.subscribeDone(n -> new StreamOrchestrator.DataHandlerCB(node, options));
        }
    }
...
//        removeStageDirectories();
    ...
    protected void printStartup() {
        System.out.println("==========================================");
        System.out.println("         CLARA Stream Orchestrator        ");
        System.out.println("==========================================");
    ...
    static class DpeReportCB implements CoreOrchestrator.DpeCallBack {
        ...
        private final Consumer<StreamProcessingNode> nodeConsumer;

        private final Map<String, StreamProcessingNode.Builder> waitingNodes = new HashMap<>();
        private final Map<String, StreamProcessingNode> availableNodes = new HashMap<>();
        ...
        DpeReportCB(CoreOrchestrator orchestrator,
                    ...
                    Consumer<StreamProcessingNode> nodeConsumer) {
        ...
        public void callback(DpeInfo dpe) {
            synchronized (availableNodes) {
                ...
                StreamProcessingNode.Builder nodeBuilder = waitingNodes.get(nodeName);
                if (nodeBuilder == null) {
                    nodeBuilder = new StreamProcessingNode.Builder(application);
                ...
                if (nodeBuilder.isReady()) {
                    StreamProcessingNode node = nodeBuilder.build(orchestrator);
        ...
        public StreamProcessingNode getLocalNode() {
    ...
    static class DataHandlerCB implements EngineCallback {
        ...
        private final StreamProcessingNode localNode;
        private final OrchestratorOptions options;

        DataHandlerCB(StreamProcessingNode localNode,
                      OrchestratorOptions options) {
    ...
    static class CommandLineBuilder {
        ...
        public void parse(String[] args) {
            try {
                ...
                if (numArgs == 0) {
                    throw new StreamOrchestrator.CommandLineException("missing arguments");
                }
                if (numArgs < 2 || numArgs > 3) {
                    throw new StreamOrchestrator.CommandLineException("invalid number of arguments");
                }
            } catch (OptionException e) {
                throw new StreamOrchestrator.CommandLineException(e);
            }
        }
        ...
        public StreamOrchestrator build() {
            try {
                ...
                StreamOrchestrator.Builder builder;
                if (files.size() == 1) {
                    builder = new StreamOrchestrator.Builder(services, parseInputFiles(files.get(0)));
                    ...
                    builder = new StreamOrchestrator.Builder(services, files.get(0), files.get(1));
                }
